...
<svg xmlns="http://www.w3.org/2000/svg" {...$$restProps}   viewBox="0 0 16 16">
	<g fill="none" stroke="rgb(var(--peach)" stroke-linecap="round" stroke-linejoin="round">
		<path d="m 12.86,6.72 c 0,0 1.39,-1.98 0.08,-3.87 C 11.28625,0.7625 9.44,1.6 9.44,1.6 c 0,0 -3.29,1.75 -5.11,2.99 -1.4,1 -2.24,2.26 -1.03,4.37 1.22,2.1 4.58,1.21 4.58,1.21" />
